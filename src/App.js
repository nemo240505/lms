    ...
    return (
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <button
                ...
                className="mb-6 bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-md transition duration-200"
            >
                Back to Dashboard
            </button>
            ...
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="lg:w-1/4 bg-white p-6 rounded-lg shadow-md">
                    <h2 className="text-2xl font-semibold text-gray-700 mb-4">Course Content</h2>
                    <nav className="space-y-4">
                        {course.modules && course.modules.map((module) => (
                            <div key={module.id}>
                                <h3 className="text-xl font-bold text-blue-700 mb-2">{module.title}</h3>
                ...
                <div className="lg:w-3/4 bg-white p-6 rounded-lg shadow-md">
                    {selectedLesson ? (
                        ...
                        <p className="text-gray-600 text-center py-10">Select a lesson from the left to view its content.</p>
                    )}
                </div>
            </div>
        </div>
